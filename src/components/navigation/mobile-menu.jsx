    ...
    <Nav xs={12}>
      <ul onClick={props.onClick}
        ...
        <li>
         ...
         <li>
        <MobileExternalLink  href="https://www.facebook.com/AB-Architektura-777333362388913"><img src={facebook} alt="instagram" /></MobileExternalLink>
        <MobileExternalLink href="https://www.instagram.com/aplusb_architektura/?hl=pl"><img src={instagram} alt="instagram" /></MobileExternalLink>
        </li>
