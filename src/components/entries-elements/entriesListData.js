...
export const entriesListData = [
  {
    imgSrc: AB_B2_1,
    path: '/entries/kuchnia_bytom_B2',
    title: 'Kuchnia_Bytom_B2',
    subtitle: 'Wnętrza',
  },
  {
    imgSrc: AB_B6_1,
    path: '/entries/kuchnia_bytom_B6',
    title: 'Kuchnia_Bytom_B6',
    subtitle: 'Wnętrza',
  },
  {
    imgSrc: AB_C7_1,
    path: '/entries/domCieszynC7',
    title: 'Dom_jednorodzinny_C7',
    subtitle: 'Wnętrza',
  },{
    imgSrc: AB_K18_1,
    path: '/entries/apartament_katowice_k18',
    title: 'Apartament_Katowice_K18',
    subtitle: 'Wnętrza',
  },
  {
    imgSrc: AB_PWZ7_1,
    path: '/entries/dom_jednorodzinny_psary_p7',
    title: 'Dom_jednorodzinny_Psary_P7',
    subtitle: 'Wnętrza',
  }
];
